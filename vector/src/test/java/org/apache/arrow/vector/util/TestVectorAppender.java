...
public class TestVectorAppender {
    ...
    public void testAppendFixedWidthVector() {
        ...
        final int length2 = 5;
        try (
            IntVector target = new IntVector("", allocator);
    ...
    public void testAppendBitVector() {
        ...
        final int length2 = 5;
        try (
            BitVector target = new BitVector("", allocator);
    ...
    public void testAppendVariableWidthVector() {
        ...
        final int length2 = 5;
        try (
            VarCharVector target = new VarCharVector("", allocator);
            ...
            try (
                VarCharVector expected = new VarCharVector(
                    "expected",
                    allocator
                )
            ) {
    ...
    public void testAppendVariableWidthViewVector() {
        ...
        final int length2 = 5;
        try (
            ViewVarCharVector target = new ViewVarCharVector("", allocator);
            ...
            target.accept(
                new RangeEqualsVisitor(target, delta),
                new Range(10, 0, 5)
            );
        }
    }
    ...
    public void testAppendLargeAndSmallVariableVectorsWithinLimit() {
        int sixteenthOfMaxAllocation = Math.toIntExact(
            BaseValueVector.MAX_ALLOCATION_SIZE / 16
        );
        try (
            VarCharVector target = makeVarCharVec(1, sixteenthOfMaxAllocation);
    ...
    private VarCharVector makeVarCharVec(int numElements, int bytesPerElement) {
        ...
        for (int i = 0; i < numElements; i++) {
            String s = String.join(
                "",
                Collections.nCopies(bytesPerElement, "a")
            );
    ...
    public void testAppendLargeVariableWidthVector() {
        ...
        try (
            LargeVarCharVector target = new LargeVarCharVector("", allocator);
            ...
            try (
                LargeVarCharVector expected = new LargeVarCharVector(
                    "expected",
                    allocator
                )
            ) {
    ...
    public void testAppendFixedSizeListVector() {
        try (
            FixedSizeListVector target = FixedSizeListVector.empty(
                "target",
                5,
                allocator
            );
            FixedSizeListVector delta = FixedSizeListVector.empty(
                "delta",
                5,
                allocator
            )
    ...
    public void testAppendStructVector() {
        ...
        final int length2 = 5;
        try (
            final StructVector target = StructVector.empty("target", allocator);
            final StructVector delta = StructVector.empty("delta", allocator)
        ) {
            IntVector targetChild1 = target.addOrGet(
                "f0",
                FieldType.nullable(new ArrowType.Int(32, true)),
                IntVector.class
            );
            VarCharVector targetChild2 = target.addOrGet(
                "f1",
            ...
            IntVector deltaChild1 = delta.addOrGet(
                "f0",
                FieldType.nullable(new ArrowType.Int(32, true)),
                IntVector.class
            );
            VarCharVector deltaChild2 = delta.addOrGet(
                "f1",
                FieldType.nullable(new ArrowType.Utf8()),
                VarCharVector.class
            );
            ...
            try (
                IntVector expected1 = new IntVector("expected1", allocator);
                VarCharVector expected2 = new VarCharVector(
                    "expected2",
                    allocator
                )
            ) {
    ...
    public void testAppendUnionVector() {
        ...
        try (
            final UnionVector target = UnionVector.empty("target", allocator);
    ...
    private DenseUnionVector getTargetVector() {
        ...
        floatHolder.isSet = 1;
        DenseUnionVector targetVector = new DenseUnionVector(
            "target vector",
            allocator,
            null,
            null
        ...
        byte intTypeId = targetVector.registerNewTypeId(
            Field.nullable("", Types.MinorType.INT.getType())
        );
        ...
        byte longTypeId = targetVector.registerNewTypeId(
    ...
    private DenseUnionVector getDeltaVector() {
        ...
        DenseUnionVector deltaVector = new DenseUnionVector(
            "target vector",
            allocator,
            null,
            null
        ...
        byte intTypeId = deltaVector.registerNewTypeId(
            Field.nullable("", Types.MinorType.INT.getType())
        );
        deltaVector.setTypeId(0, intTypeId);
        intHolder.value = 7;
        deltaVector.setSafe(0, intHolder);
        byte longTypeId = deltaVector.registerNewTypeId(
            Field.nullable("", Types.MinorType.BIGINT.getType())
        );
        deltaVector.setTypeId(2, longTypeId);
        longHolder.value = 8L;
        deltaVector.setSafe(2, longHolder);
        byte floatTypeId = deltaVector.registerNewTypeId(
            Field.nullable("", Types.MinorType.FLOAT4.getType())
        );
        ...
        assertVectorValuesEqual(
            deltaVector,
            new Object[] { 7, null, 8L, 9.0f }
        );
        return deltaVector;
    }
    ...
    public void testAppendDenseUnionVector() {
        try (
            DenseUnionVector targetVector = getTargetVector();
            ...
            assertVectorValuesEqual(
                targetVector,
                new Object[] { 1, 2, null, 10L, 7, null, 8L, 9.0f }
            );
        }
        ...
        try (
            ...
            assertVectorValuesEqual(
                deltaVector,
                new Object[] { 7, null, 8L, 9.0f, 1, 2, null, 10L }
            );
        }
    }
    ...
    public void testAppendDenseUnionVectorMismatch() {
        ...
        try (
            ...
            intTypeId = deltaVector.registerNewTypeId(
                Field.nullable("", Types.MinorType.INT.getType())
            );
            deltaVector.setTypeId(0, intTypeId);
            intHolder.value = 3;
    ...
    public static void assertVectorsEqual(
        ValueVector vector1,
        ValueVector vector2
    ) {
        assertEquals(vector1.getValueCount(), vector2.getValueCount());

        TypeEqualsVisitor typeEqualsVisitor = new TypeEqualsVisitor(
            vector1,
            false,
            false
        );
        RangeEqualsVisitor equalsVisitor = new RangeEqualsVisitor(
            vector1,
            vector2,
            (v1, v2) -> typeEqualsVisitor.equals(vector2)
        );
        assertTrue(
            equalsVisitor.rangeEquals(new Range(0, 0, vector1.getValueCount()))
        );
    }
}
